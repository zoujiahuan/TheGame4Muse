 ...
 * @default ====================================
 *
 * @param Game Reconstruction
 * @type boolean
 * @desc Allows for game reconstruction; if disabled, all the "Game Window" parameters will also be disabled.
 * @default true
 * @parent Game Window
 *
...
Imported["SumRndmDde Game Upgrade"] = 1.21;
...
window.onload = function() {
	if(_.params['Game Reconstruction'] && GameWindowManager.isWindowOriginal()) {
